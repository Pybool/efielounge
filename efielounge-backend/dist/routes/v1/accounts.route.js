...
authRouter.put('/user-profile', jwt_1.decode, (0, menu_middleware_1.getMulterConfigSingle)('../public/accounts/admin/'), account_controller_1.default.saveUserProfile);
authRouter.post('/upload-avatar', jwt_1.decode, (0, menu_middleware_1.getMulterConfigSingle)('../public/accounts/customers/'), account_controller_1.default.uploadAvatar);
